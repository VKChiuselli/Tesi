...
@Entity
@Table(name = "utenti", catalog = "opengest")
public class User extends BaseEntity implements java.io.Serializable {
    ...
    @ManyToMany()
    @JoinTable(name = "auth_group_members", joinColumns = @JoinColumn(name = "id_utente", 
    			referencedColumnName = "id_utente"), 
    			inverseJoinColumns = @JoinColumn(name = "group_id", referencedColumnName = "id_tipi_spese"))
