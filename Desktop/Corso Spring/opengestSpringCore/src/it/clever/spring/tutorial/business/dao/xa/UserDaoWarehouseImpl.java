 ...
 */
//@Repository("userDao")
public class UserDaoWarehouseImpl implements UserDao {

	@Autowired
	private SessionFactory warehouseSessionFactory;
	
	@Override
	public Integer save(User entity) throws Exception {
		return (Integer) this.warehouseSessionFactory.getCurrentSession().save(entity);
	}
	
	@Override
	public void saveOrUpdate(User entity) throws Exception {
		warehouseSessionFactory.getCurrentSession().saveOrUpdate(entity);
	}
	
	@Override
	public void persist(User entity) throws Exception {
		this.warehouseSessionFactory.getCurrentSession().persist(entity);
	}

	@Override
	public void update(User entity) throws Exception {
		this.warehouseSessionFactory.getCurrentSession().update(entity);
	}

	@Override
	public User findById(Serializable id) throws Exception {
		return (User) this.warehouseSessionFactory.getCurrentSession().get(User.class, id);
	}
	@Override
	public void delete(User entity) throws Exception {
		this.warehouseSessionFactory.getCurrentSession().delete(entity);
	}

	@Override
	public User merge(User entity) throws Exception {
		return (User) this.warehouseSessionFactory.getCurrentSession().merge(entity);
	}

	@Override
	public List<User> findAll() throws Exception {

		List<User> retuserList = this.warehouseSessionFactory.getCurrentSession().createQuery("from User")
				.list();
		return retuserList;
	}

	public User findByUsername(String username) {
		Query query = this.warehouseSessionFactory.getCurrentSession().createQuery(
	...
	public List<User> findUsersByDepartment(Integer deptId, String deptCode)
		...
		Query query = this.warehouseSessionFactory.getCurrentSession().createQuery(q1);
	...
	public List<User> findUsersByCriteriaFilters(String name, String surname, String email)
		...
		Criteria criteria = this.warehouseSessionFactory.getCurrentSession()
    ...
    public void setWarehouseSessionFactory(SessionFactory sessionFactory) {
        this.warehouseSessionFactory = sessionFactory;
    }

//	public SessionFactory getWarehouseSessionFactory() {
//		return warehouseSessionFactory;
//	}
