...
import it.clever.opengest.web.controllers.CustomerController;
...
privileged aspect CustomerController_Roo_Controller {
    ...
    public String CustomerController.create(@Valid Customer customer, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        ...
        uiModel.asMap().clear();
        customer.persist();
        return "redirect:/customers/" + encodeUrlPathSegment(customer.getIdCliente().toString(), httpServletRequest);
    }
    ...
    @RequestMapping(value = "/{idCliente}", produces = "text/html")
    public String CustomerController.show(@PathVariable("idCliente") Integer idCliente, Model uiModel) {
        uiModel.addAttribute("customer", Customer.findCustomer(idCliente));
        uiModel.addAttribute("itemId", idCliente);
    ...
    @RequestMapping(value = "/{idCliente}", params = "form", produces = "text/html")
    public String CustomerController.updateForm(@PathVariable("idCliente") Integer idCliente, Model uiModel) {
        populateEditForm(uiModel, Customer.findCustomer(idCliente));
        return "customers/update";
    }
    
    @RequestMapping(value = "/{idCliente}", method = RequestMethod.DELETE, produces = "text/html")
    public String CustomerController.delete(@PathVariable("idCliente") Integer idCliente, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        Customer customer = Customer.findCustomer(idCliente);
        customer.remove();
        uiModel.asMap().clear();
